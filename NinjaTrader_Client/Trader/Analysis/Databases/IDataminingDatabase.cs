...
namespace NinjaTrader_Client.Trader.Datamining
{
    public interface IDataminingDatabase
    {
        ...
        void getOutcomeIndicatorSampling(SampleOutcomeExcelGenerator excel, string indicatorId, int outcomeTimeframeSeconds, string instument = null); //double min, double max, int steps, 
        void getOutcomeIndicatorSampling(SampleOutcomeExcelGenerator excel, double min, double max, int steps, string indicatorId, int outcomeTimeframeSeconds, string instument = null);
